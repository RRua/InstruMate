...
class Intent(object):
    """
    this class describes an intent event
    """
    ...
    def to_dict(self):
        intent_dict = {
            ...
            "extra_boolean": self.extra_boolean,
            "extra_int": self.extra_int,
            "extra_long": self.extra_long,
            "extra_float": self.extra_float,
            "extra_uri": self.extra_uri,
            "extra_component": self.extra_component,
            "extra_array_int": self.extra_array_int,
            "extra_array_long": self.extra_array_long,
            "extra_array_float": self.extra_array_float,
            "flags": self.flags,
            "suffix": self.suffix,
            "cmd": self.get_cmd(),
        }
