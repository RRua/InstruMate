...
class RepackagerByFridaGadgetWithApkTool(GenericApkToolRepackager):

    def __init__(self, tag='by-fridagadgetapktool'):
    ...
    def get_known_features(self):
        return [av.FEATURE_MONITOR_METHOD_CALLS_WITH_FRIDA_GADGET]
    ...
    def instrument(self, apk_file: str, unpacked_dir: str, instrumentable_version: str, is_base,
        ...
        smali_dirs = instrumentable_version if instrumentable_version is not None else []
        qtd_injections = 0
        for smali_dir in smali_dirs:
            ...
            lib_dir = os.path.join(unpacked_dir, 'lib')
